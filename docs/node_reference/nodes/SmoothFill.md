...
![img](../../images/nodes/SmoothFill_hsd_example.png)

Corresponding Hesiod file: [SmoothFill.hsd](../../examples/SmoothFill.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
