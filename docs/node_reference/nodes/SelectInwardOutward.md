...
![img](../../images/nodes/SelectInwardOutward_hsd_example.png)

Corresponding Hesiod file: [SelectInwardOutward.hsd](../../examples/SelectInwardOutward.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
