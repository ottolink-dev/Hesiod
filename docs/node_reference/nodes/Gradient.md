...
![img](../../images/nodes/Gradient_hsd_example.png)

Corresponding Hesiod file: [Gradient.hsd](../../examples/Gradient.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
