...
| :--- | :--- | :--- |
|control|VirtualArray|Optional input to guide Voronoi jittering.|
...
|Name|Type|Description|
| :--- | :--- | :--- |
|output|VirtualArray|Final heightmap result generated by the fBm Voronoi algorithm.|
...
||Enumeration|Defines the type of Voronoi information returned.|
...
![img](../../images/nodes/VoronoiFbm_hsd_example.png)

Corresponding Hesiod file: [VoronoiFbm.hsd](../../examples/VoronoiFbm.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
