...
|Smoothing|Float|Smoothing factor (typically in [0, 1]).|
...
![img](../../images/nodes/GammaCorrectionLocal_hsd_example.png)

Corresponding Hesiod file: [GammaCorrectionLocal.hsd](../../examples/GammaCorrectionLocal.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
