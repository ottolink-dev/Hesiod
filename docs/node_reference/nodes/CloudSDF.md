...
![img](../../images/nodes/CloudSDF_hsd_example.png)

Corresponding Hesiod file: [CloudSDF.hsd](../../examples/CloudSDF.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
