...
![img](../../images/nodes/TextureQuiltingExpand_hsd_example.png)

Corresponding Hesiod file: [TextureQuiltingExpand.hsd](../../examples/TextureQuiltingExpand.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
