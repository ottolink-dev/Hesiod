...
|Enable Dequantize|Bool|No description|
...
![img](../../images/nodes/ImportHeightmap_hsd_example.png)

Corresponding Hesiod file: [ImportHeightmap.hsd](../../examples/ImportHeightmap.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
