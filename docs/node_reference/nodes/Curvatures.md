...
![img](../../images/nodes/Curvatures_hsd_example.png)

Corresponding Hesiod file: [Curvatures.hsd](../../examples/Curvatures.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
