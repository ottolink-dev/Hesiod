...
![img](../../images/nodes/AbsSmooth_hsd_example.png)

Corresponding Hesiod file: [AbsSmooth.hsd](../../examples/AbsSmooth.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
