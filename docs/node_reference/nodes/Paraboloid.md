...
![img](../../images/nodes/Paraboloid_hsd_example.png)

Corresponding Hesiod file: [Paraboloid.hsd](../../examples/Paraboloid.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
