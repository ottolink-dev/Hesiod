...
![img](../../images/nodes/NoiseRidged_hsd_example.png)

Corresponding Hesiod file: [NoiseRidged.hsd](../../examples/NoiseRidged.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
