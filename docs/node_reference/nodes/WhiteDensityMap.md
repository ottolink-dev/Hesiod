...
![img](../../images/nodes/WhiteDensityMap_hsd_example.png)

Corresponding Hesiod file: [WhiteDensityMap.hsd](../../examples/WhiteDensityMap.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
