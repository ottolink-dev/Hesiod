...
![img](../../images/nodes/ProjectTalus_hsd_example.png)

Corresponding Hesiod file: [ProjectTalus.hsd](../../examples/ProjectTalus.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
