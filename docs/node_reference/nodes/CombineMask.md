...
![img](../../images/nodes/CombineMask_hsd_example.png)

Corresponding Hesiod file: [CombineMask.hsd](../../examples/CombineMask.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
