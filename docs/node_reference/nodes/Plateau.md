...
![img](../../images/nodes/Plateau_hsd_example.png)

Corresponding Hesiod file: [Plateau.hsd](../../examples/Plateau.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
