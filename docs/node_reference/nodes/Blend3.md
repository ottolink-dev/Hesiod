...
| :--- | :--- | :--- |
|input 1|VirtualArray|No description|
...
![img](../../images/nodes/Blend3_hsd_example.png)

Corresponding Hesiod file: [Blend3.hsd](../../examples/Blend3.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
