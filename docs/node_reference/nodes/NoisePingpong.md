...
![img](../../images/nodes/NoisePingpong_hsd_example.png)

Corresponding Hesiod file: [NoisePingpong.hsd](../../examples/NoisePingpong.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
