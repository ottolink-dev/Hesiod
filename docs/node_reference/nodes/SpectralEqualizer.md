...
![img](../../images/nodes/SpectralEqualizer_hsd_example.png)

Corresponding Hesiod file: [SpectralEqualizer.hsd](../../examples/SpectralEqualizer.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
