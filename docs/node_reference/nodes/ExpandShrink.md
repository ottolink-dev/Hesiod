...
![img](../../images/nodes/ExpandShrink_hsd_example.png)

Corresponding Hesiod file: [ExpandShrink.hsd](../../examples/ExpandShrink.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
