...
![img](../../images/nodes/Bulkify_settings.png)
...
![img](../../images/nodes/Bulkify_hsd_example.png)

Corresponding Hesiod file: [Bulkify.hsd](../../examples/Bulkify.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
