...
![img](../../images/nodes/Multisteps_hsd_example.png)

Corresponding Hesiod file: [Multisteps.hsd](../../examples/Multisteps.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
