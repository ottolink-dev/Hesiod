...
![img](../../images/nodes/ConeSigmoid_hsd_example.png)

Corresponding Hesiod file: [ConeSigmoid.hsd](../../examples/ConeSigmoid.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
