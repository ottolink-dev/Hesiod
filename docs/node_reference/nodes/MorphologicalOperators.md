...
![img](../../images/nodes/MorphologicalOperators_hsd_example.png)

Corresponding Hesiod file: [MorphologicalOperators.hsd](../../examples/MorphologicalOperators.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
