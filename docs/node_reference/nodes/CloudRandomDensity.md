...
![img](../../images/nodes/CloudRandomDensity_hsd_example.png)

Corresponding Hesiod file: [CloudRandomDensity.hsd](../../examples/CloudRandomDensity.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
