...
![img](../../images/nodes/WaveTriangular_hsd_example.png)

Corresponding Hesiod file: [WaveTriangular.hsd](../../examples/WaveTriangular.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
