...
![img](../../images/nodes/PolygonField_hsd_example.png)

Corresponding Hesiod file: [PolygonField.hsd](../../examples/PolygonField.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
