...
![img](../../images/nodes/SelectRivers_hsd_example.png)

Corresponding Hesiod file: [SelectRivers.hsd](../../examples/SelectRivers.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
