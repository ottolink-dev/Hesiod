...
Apply histogram equalization to the input heightmap.



![img](../../images/nodes/Equalize_settings.png)
...
![img](../../images/nodes/Equalize_hsd_example.png)

Corresponding Hesiod file: [Equalize.hsd](../../examples/Equalize.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
