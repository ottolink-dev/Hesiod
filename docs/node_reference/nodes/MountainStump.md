...
![img](../../images/nodes/MountainStump_hsd_example.png)

Corresponding Hesiod file: [MountainStump.hsd](../../examples/MountainStump.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
