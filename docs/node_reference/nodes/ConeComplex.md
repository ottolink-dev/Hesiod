...
![img](../../images/nodes/ConeComplex_hsd_example.png)

Corresponding Hesiod file: [ConeComplex.hsd](../../examples/ConeComplex.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
