...
|Name|Type|Description|
| :--- | :--- | :--- |
|output|VirtualArray|WaveSquare heightmap.|
...
![img](../../images/nodes/WaveSquare_hsd_example.png)

Corresponding Hesiod file: [WaveSquare.hsd](../../examples/WaveSquare.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
