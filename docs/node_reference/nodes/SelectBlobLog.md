...
![img](../../images/nodes/SelectBlobLog_hsd_example.png)

Corresponding Hesiod file: [SelectBlobLog.hsd](../../examples/SelectBlobLog.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
