...
![img](../../images/nodes/Thermal_hsd_example.png)

Corresponding Hesiod file: [Thermal.hsd](../../examples/Thermal.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
