...
![img](../../images/nodes/Saturate_hsd_example.png)

Corresponding Hesiod file: [Saturate.hsd](../../examples/Saturate.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
