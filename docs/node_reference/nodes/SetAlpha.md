...
![img](../../images/nodes/SetAlpha_hsd_example.png)

Corresponding Hesiod file: [SetAlpha.hsd](../../examples/SetAlpha.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
