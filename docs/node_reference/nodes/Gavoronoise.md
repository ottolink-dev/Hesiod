...
![img](../../images/nodes/Gavoronoise_hsd_example.png)

Corresponding Hesiod file: [Gavoronoise.hsd](../../examples/Gavoronoise.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
