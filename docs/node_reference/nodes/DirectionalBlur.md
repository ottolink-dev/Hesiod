...
![img](../../images/nodes/DirectionalBlur_hsd_example.png)

Corresponding Hesiod file: [DirectionalBlur.hsd](../../examples/DirectionalBlur.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
