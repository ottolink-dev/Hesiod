...
|Name|Type|Description|
| :--- | :--- | :--- |
|output|VirtualArray|Gradient angle.|
...
![img](../../images/nodes/GradientAngle_hsd_example.png)

Corresponding Hesiod file: [GradientAngle.hsd](../../examples/GradientAngle.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
