...
|K Max|Float|Upper bound smoothing intensity.|
|K Min|Float|Lower bound smoothing intensity.|
...
![img](../../images/nodes/Clamp_hsd_example.png)

Corresponding Hesiod file: [Clamp.hsd](../../examples/Clamp.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
