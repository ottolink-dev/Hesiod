...
![img](../../images/nodes/Slope_hsd_example.png)

Corresponding Hesiod file: [Slope.hsd](../../examples/Slope.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
