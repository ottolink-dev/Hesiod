...
![img](../../images/nodes/ShatteredPeak_hsd_example.png)

Corresponding Hesiod file: [ShatteredPeak.hsd](../../examples/ShatteredPeak.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
