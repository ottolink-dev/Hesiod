...
![img](../../images/nodes/DistanceTransform_hsd_example.png)

Corresponding Hesiod file: [DistanceTransform.hsd](../../examples/DistanceTransform.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
