...
![img](../../images/nodes/Plates_hsd_example.png)

Corresponding Hesiod file: [Plates.hsd](../../examples/Plates.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
