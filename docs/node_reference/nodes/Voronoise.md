...
![img](../../images/nodes/Voronoise_hsd_example.png)

Corresponding Hesiod file: [Voronoise.hsd](../../examples/Voronoise.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
