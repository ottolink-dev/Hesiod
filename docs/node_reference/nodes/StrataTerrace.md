...
![img](../../images/nodes/StrataTerrace_settings.png)
...
![img](../../images/nodes/StrataTerrace_hsd_example.png)

Corresponding Hesiod file: [StrataTerrace.hsd](../../examples/StrataTerrace.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
