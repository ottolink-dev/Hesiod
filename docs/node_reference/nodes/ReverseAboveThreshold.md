...
![img](../../images/nodes/ReverseAboveThreshold_hsd_example.png)

Corresponding Hesiod file: [ReverseAboveThreshold.hsd](../../examples/ReverseAboveThreshold.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
