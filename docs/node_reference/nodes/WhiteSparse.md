...
![img](../../images/nodes/WhiteSparse_hsd_example.png)

Corresponding Hesiod file: [WhiteSparse.hsd](../../examples/WhiteSparse.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
