...
![img](../../images/nodes/QuiltingExpand_hsd_example.png)

Corresponding Hesiod file: [QuiltingExpand.hsd](../../examples/QuiltingExpand.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
