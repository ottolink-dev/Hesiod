...
![img](../../images/nodes/SmoothCpulse_hsd_example.png)

Corresponding Hesiod file: [SmoothCpulse.hsd](../../examples/SmoothCpulse.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
