...
![img](../../images/nodes/NoiseJordan_hsd_example.png)

Corresponding Hesiod file: [NoiseJordan.hsd](../../examples/NoiseJordan.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
