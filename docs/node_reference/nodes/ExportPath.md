...
![img](../../images/nodes/ExportPath_hsd_example.png)

Corresponding Hesiod file: [ExportPath.hsd](../../examples/ExportPath.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
