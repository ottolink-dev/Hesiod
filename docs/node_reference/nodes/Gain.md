...
![img](../../images/nodes/Gain_hsd_example.png)

Corresponding Hesiod file: [Gain.hsd](../../examples/Gain.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
