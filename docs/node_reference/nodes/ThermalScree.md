...
![img](../../images/nodes/ThermalScree_hsd_example.png)

Corresponding Hesiod file: [ThermalScree.hsd](../../examples/ThermalScree.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
