...
| :--- | :--- | :--- |
|input 1|VirtualArray|Primary heightmap input.|
...
![img](../../images/nodes/BlendPoissonBf_hsd_example.png)

Corresponding Hesiod file: [BlendPoissonBf.hsd](../../examples/BlendPoissonBf.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
