...
![img](../../images/nodes/SelectInterval_hsd_example.png)

Corresponding Hesiod file: [SelectInterval.hsd](../../examples/SelectInterval.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
