...
![img](../../images/nodes/SmoothFillSmearPeaks_hsd_example.png)

Corresponding Hesiod file: [SmoothFillSmearPeaks.hsd](../../examples/SmoothFillSmearPeaks.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
