...
![img](../../images/nodes/NoiseFbm_hsd_example.png)

Corresponding Hesiod file: [NoiseFbm.hsd](../../examples/NoiseFbm.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
