...
![img](../../images/nodes/Blend_hsd_example.png)

Corresponding Hesiod file: [Blend.hsd](../../examples/Blend.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
