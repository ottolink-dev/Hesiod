...
![img](../../images/nodes/NoiseIq_hsd_example.png)

Corresponding Hesiod file: [NoiseIq.hsd](../../examples/NoiseIq.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
