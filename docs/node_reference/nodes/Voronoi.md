...
|Name|Type|Description|
| :--- | :--- | :--- |
|out|VirtualArray|Resulting heightmap generated by the Voronoi algorithm.|
...
![img](../../images/nodes/Voronoi_hsd_example.png)

Corresponding Hesiod file: [Voronoi.hsd](../../examples/Voronoi.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
