...
![img](../../images/nodes/SmoothFillHoles_hsd_example.png)

Corresponding Hesiod file: [SmoothFillHoles.hsd](../../examples/SmoothFillHoles.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
