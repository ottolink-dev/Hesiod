...
![img](../../images/nodes/NoiseSwiss_hsd_example.png)

Corresponding Hesiod file: [NoiseSwiss.hsd](../../examples/NoiseSwiss.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
