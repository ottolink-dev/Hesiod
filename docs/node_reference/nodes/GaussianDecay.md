...
![img](../../images/nodes/GaussianDecay_hsd_example.png)

Corresponding Hesiod file: [GaussianDecay.hsd](../../examples/GaussianDecay.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
