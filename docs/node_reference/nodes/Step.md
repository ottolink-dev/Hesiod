...
|Name|Type|Description|
| :--- | :--- | :--- |
|output|VirtualArray|Step heightmap.|
...
![img](../../images/nodes/Step_hsd_example.png)

Corresponding Hesiod file: [Step.hsd](../../examples/Step.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
