...
![img](../../images/nodes/WaveDune_hsd_example.png)

Corresponding Hesiod file: [WaveDune.hsd](../../examples/WaveDune.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
