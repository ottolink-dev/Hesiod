...
![img](../../images/nodes/NoiseParberry_hsd_example.png)

Corresponding Hesiod file: [NoiseParberry.hsd](../../examples/NoiseParberry.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
