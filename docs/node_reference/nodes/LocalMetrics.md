...
![img](../../images/nodes/LocalMetrics_hsd_example.png)

Corresponding Hesiod file: [LocalMetrics.hsd](../../examples/LocalMetrics.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
