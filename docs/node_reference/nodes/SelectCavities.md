...
|Name|Type|Description|
| :--- | :--- | :--- |
||Bool|Decides whether concave or convex features are detected.|
...
![img](../../images/nodes/SelectCavities_hsd_example.png)

Corresponding Hesiod file: [SelectCavities.hsd](../../examples/SelectCavities.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
