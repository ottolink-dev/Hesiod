...
![img](../../images/nodes/SelectValley_hsd_example.png)

Corresponding Hesiod file: [SelectValley.hsd](../../examples/SelectValley.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
