...
![img](../../images/nodes/GaborWaveFbm_hsd_example.png)

Corresponding Hesiod file: [GaborWaveFbm.hsd](../../examples/GaborWaveFbm.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
