...
![img](../../images/nodes/Stamping_hsd_example.png)

Corresponding Hesiod file: [Stamping.hsd](../../examples/Stamping.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
