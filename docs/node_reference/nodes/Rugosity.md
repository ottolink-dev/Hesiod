...
![img](../../images/nodes/Rugosity_hsd_example.png)

Corresponding Hesiod file: [Rugosity.hsd](../../examples/Rugosity.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
