...
![img](../../images/nodes/DepositionFillHoles_settings.png)
...
|Strength|Float|No description|

## Example


![img](../../images/nodes/DepositionFillHoles_hsd_example.png)

Corresponding Hesiod file: [DepositionFillHoles.hsd](../../examples/DepositionFillHoles.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
