...
![img](../../images/nodes/RelativeDistanceFromSkeleton_hsd_example.png)

Corresponding Hesiod file: [RelativeDistanceFromSkeleton.hsd](../../examples/RelativeDistanceFromSkeleton.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
