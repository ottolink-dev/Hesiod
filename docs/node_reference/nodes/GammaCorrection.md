...
![img](../../images/nodes/GammaCorrection_hsd_example.png)

Corresponding Hesiod file: [GammaCorrection.hsd](../../examples/GammaCorrection.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
