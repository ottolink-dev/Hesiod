...
![img](../../images/nodes/Lerp_hsd_example.png)

Corresponding Hesiod file: [Lerp.hsd](../../examples/Lerp.hsd). Use [Ctrl+I] in the node editor to import a hsd file within your current project.
