...
DECLARE_NODE(cellular_noise)
DECLARE_NODE(clamp)
DECLARE_NODE(clamp_oblique)
DECLARE_NODE(circus)
DECLARE_NODE(cloud)
...
DECLARE_NODE(coastal_erosion_profile)
DECLARE_NODE(coastal_fetch)
DECLARE_NODE(color_adjust)
DECLARE_NODE(colorize_bivariate)
DECLARE_NODE(colorize_gradient)
DECLARE_NODE(colorize_solid)
DECLARE_NODE(combine_mask)
DECLARE_NODE(compare)
DECLARE_NODE(cone)
DECLARE_NODE(constant)
DECLARE_NODE(convolve_svd)
DECLARE_NODE(cos)
DECLARE_NODE(crater)
DECLARE_NODE(curvatures)
DECLARE_NODE(dendry)
DECLARE_NODE(deposition_fill_holes)
...
DECLARE_NODE(export_heightmap_streamed)
DECLARE_NODE(export_normal_map)
DECLARE_NODE(export_path)
DECLARE_NODE(export_points_to_ply)
DECLARE_NODE(export_scene)
DECLARE_NODE(export_texture)
DECLARE_NODE(export_texture_streamed)
DECLARE_NODE(export_tiled)
DECLARE_NODE(falloff)
DECLARE_NODE(fill_talus)
DECLARE_NODE(find_cut_path)
DECLARE_NODE(flatbed_carve)
DECLARE_NODE(flooding_from_boundaries)
DECLARE_NODE(flooding_from_point)
DECLARE_NODE(flooding_lake_system)
DECLARE_NODE(flow_fixing_mst)
DECLARE_NODE(flow_simulation)
DECLARE_NODE(flow_simulation_viscous)
...
DECLARE_NODE(island)
DECLARE_NODE(island_chain)
DECLARE_NODE(island_land_mask)
DECLARE_NODE(jagged)
DECLARE_NODE(kernel_cupola)
...
DECLARE_NODE(lerp)
DECLARE_NODE(level_set_curvature)
DECLARE_NODE(local_metrics)
DECLARE_NODE(loose_symmetry)
...
DECLARE_NODE(mix_texture_masked)
DECLARE_NODE(mixer)
DECLARE_NODE(morphological_operators)
...
DECLARE_NODE(snow_melting_map)
DECLARE_NODE(snow_simulation)
DECLARE_NODE(spectral_equalizer)
DECLARE_NODE(stamping)
DECLARE_NODE(strata)
DECLARE_NODE(strata_cells)
DECLARE_NODE(strata_plates)
DECLARE_NODE(strata_terrace)
