...
constexpr const char *A_AMPLITUDE_RANDOM_RATIO = "amplitude_random_ratio";
...
void setup_hemisphere_field_fbm_node(BaseNode &node)
{
  ...
  add_float(node, A_AMPLITUDE_RANDOM_RATIO, "amplitude_random_ratio", 0.5f, 0.f, 1.f);
  ...
  hmap::for_each_tile(
      ...
      [&node](std::vector<hmap::Array *> p_arrays, const hmap::TileRegion &region)
      {
        ...
        *pa_out = hmap::gpu::hemisphere_field_fbm(
            ...
            node.val<float>(A_AMPLITUDE_RANDOM_RATIO),
