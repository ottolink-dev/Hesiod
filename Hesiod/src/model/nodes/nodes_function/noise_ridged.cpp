...
void setup_noise_ridged_node(BaseNode &node)
{
  ...
  node.add_attr<FloatAttribute>("k_smoothing", "k_smoothing", 0.2f, 0.f, 1.f);
...
void compute_noise_ridged_node(BaseNode &node)
{
